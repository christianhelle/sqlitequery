...
|-----------|----------|----------|
| Qt GUI / UI Features | Dallas | Modify mainwindow.ui, add UI components, signals/slots, styling, dark mode |
| Database / Export / Queries | Fenster | Query execution, CSV/SQL export, schema introspection, threading, data operations |
| Cross-Platform Testing | Hockney | CLI validation, platform-specific testing (Windows/Mac/Linux), edge cases, integration tests |
| Architecture / Code Review | Ripley | Design decisions, PR reviews, quality gates, issue triage, cross-module impact |
| Scope & Priorities | Ripley | What to build next, trade-offs, decisions, feature prioritization |
